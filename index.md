...
* Reproduction study: significant positive correlation (ρ=0.478, p<0.01) between CRT and manual inspection in a study with a variant of CRT (with no math) and different functions for manual inspection
